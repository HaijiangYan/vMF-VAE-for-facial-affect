...
tappy_set = [7, 8, 24, 25, 41, 42, 60, 61, 77, 78, 94, 95, 112, 113, 128, 129, 147, 148,
             164, 165, 181, 182, 198, 199, 217, 218, 236, 237, 255, 256, 274, 275, 293,
             ...
             1035, 1036, 1054, 1055, 1090, 1091, 1109, 1110, 1129, 1147, 1148, 1166, 1167,
             1185, 1186, 1223, 1224, 1242, 1243, 1261, 1262]  # extract the NO. of all teeth showing face
...
sad_set = [9, 10, 26, 27, 43, 44, 62, 63, 130, 131, 149, 150, 166, 167, 183, 184, 201, 202,
           ...
           1037, 1038, 1056, 1057, 1074, 1092, 1093, 1111, 1112, 1130, 1131, 1149, 1150, 1168,
           1169, 1187, 1188, 1225, 1226, 1244, 1245, 1263, 1264]  # extract the NO. of all sad face
...
fear_set = [57, 213, 214, 232, 233, 251, 252, 289, 290, 308, 309, 327, 328, 346, 347, 365, 366,
...
sup_set = [16, 17, 33, 34, 50, 51, 69, 70, 86, 87, 103, 104, 137, 138, 156, 157, 173, 174,
...
# os.mkdir('/Users/Yan/Projects/Python/DeepLearning_tf/VAE/dataset/FaceImages/balance_set')
# for i in os.listdir('/Users/Yan/Projects/Python/DeepLearning_tf/VAE/dataset/FaceImages/full_data'):
# 	if os.path.splitext(i)[1] == '.jpg':
# 		if int(i.split('.')[0]) in sup_set + fear_set + disgusted_set + anger_set + sad_set + happy_combination + neutral_balance:
# 			old = '/Users/Yan/Projects/Python/DeepLearning_tf/VAE/dataset/FaceImages/full_data/' + i
# 			new = '/Users/Yan/Projects/Python/DeepLearning_tf/VAE/dataset/FaceImages/balance_set/' + i
