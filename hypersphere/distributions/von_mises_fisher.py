...
from hypersphere.ops.ive import ive, ive_fraction_approx, ive_fraction_approx2
from hypersphere.distributions.hyperspherical_uniform import (
...
class VonMisesFisher(torch.distributions.Distribution):
    ...
    has_rsample = True  # use reparameterized samplers
